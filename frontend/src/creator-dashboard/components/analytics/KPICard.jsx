...
/**
 * Reusable KPICard component for Analytics metrics with strict grid & alignment consistency
 */
export default function KPICard({
  ...
  return (
    <div
      className={`stat-card cursor-pointer group hover:border-indigo-500/40 dark:hover:border-indigo-500/40 transition-all duration-200 h-full flex flex-col justify-between p-4 sm:p-5 border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-900 rounded-xl shadow-xs ${className}`}
    >
      {/* Top Row: Title & Centered Icon */}
      ...
      {/* Bottom Row: Growth Percentage aligned at the bottom */}
      {change && (
