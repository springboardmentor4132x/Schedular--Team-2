...
export const quickActions = [
  { title: 'Create New Post', desc: 'Draft a new Reel, Short, or Thread', icon: '✍️', link: '/creator/posts' },
  { title: 'Schedule Content', desc: 'Set date & time for upcoming posts', icon: '📅', link: '/creator/scheduling' },
  { title: 'Manage Campaigns', desc: 'Review brand briefs and guidelines', icon: '🚀', link: '/creator/campaigns' },
  { title: 'Publishing Calendar', desc: 'View monthly and weekly schedule', icon: '📆', link: '/creator/calendar' },
  { title: 'Analytics', desc: 'Track reach, engagement, and growth', icon: '📊', link: '/creator/dashboard' },
  { title: 'Settings', desc: 'Configure notifications and security', icon: '⚙️', link: '/creator/settings' },
]
