    ...
    <div className="space-y-6 max-w-7xl mx-auto animate-fade-in">
      ...
      <section className="card relative overflow-hidden bg-gradient-to-r from-indigo-50 to-purple-50/50 dark:from-indigo-950/30 dark:to-purple-950/20 border border-default shadow-card">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap gap-2">
            <button onClick={() => navigate('/creator/create-post')} className="btn btn-primary btn-md">
              <PlusCircle size={16} /> Create Post
            </button>
            <button onClick={() => navigate('/creator/publishing-calendar')} className="btn btn-outline btn-md">
      ...
      <section className="card">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {[
            { label: 'Create Post', icon: PlusCircle, desc: 'Write and schedule a new post', to: '/creator/create-post' },
            { label: 'Publishing Calendar', icon: Calendar, desc: 'View your content calendar', to: '/creator/publishing-calendar' },
            { label: 'Open Queue', icon: ListOrdered, desc: 'Manage the publishing queue', to: '/creator/publishing/queue' },
            { label: 'View Logs', icon: FileText, desc: 'Check publishing history', to: '/creator/publishing/logs' },
          ].map((action) => (
            <button
              key={action.label}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="card lg:col-span-2 space-y-4">
          <div className="flex items-center justify-between border-b border-default pb-3">
            ...
            <button onClick={() => navigate('/creator/publishing/logs')} className="text-xs font-semibold text-indigo-600 dark:text-indigo-400 hover:underline flex items-center gap-1">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="card space-y-4">
          <div className="flex items-center justify-between border-b border-default pb-3">
            ...
            <button onClick={() => navigate('/creator/publishing-calendar')} className="text-xs font-semibold text-indigo-600 dark:text-indigo-400 hover:underline flex items-center gap-1">
