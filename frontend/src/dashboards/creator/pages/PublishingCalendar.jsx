...
export default function PublishingCalendar() {
  ...
  const handleCreatePostSimulated = () => {
    navigate('/dashboard/creator/create-post')
  }
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 items-start">
                              ...
                              <button
                                ...
                                className={`
                                  ...
                                  ${post.status === 'Draft' ? 'bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-300' :
                                    post.status === 'Scheduled' ? 'bg-indigo-50 dark:bg-indigo-950/60 text-indigo-700 dark:text-indigo-400' :
                                    post.status === 'Published' ? 'bg-emerald-50 dark:bg-emerald-950/60 text-emerald-700 dark:text-emerald-400' :
                                    post.status === 'Missed' ? 'bg-rose-50 dark:bg-rose-950/60 text-rose-700 dark:text-rose-400' :
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-7 gap-2 min-h-[220px]">
                  {['2026-07-26', '2026-07-27', '2026-07-28', '2026-07-29', '2026-07-30', '2026-07-31', '2026-08-01'].map((dateStr, i) => {
                    ...
                    return (
                      <div key={i} className="p-2 border rounded-xl bg-slate-50/50 dark:bg-slate-800/30 flex flex-col space-y-2">
                        {dayPosts.map(post => {
                          const PlatformIcon = post.platformIcon
                          return (
                            <div 
        ...
        <div className="space-y-6">
          <div className="card p-5 space-y-4 shadow-card">
            ...
            <div className="space-y-2">
              <h3 className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Today (July 22)</h3>
            ...
            <div className="space-y-2">
              <h3 className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Tomorrow (July 23)</h3>
