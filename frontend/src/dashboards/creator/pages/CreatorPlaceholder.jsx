export default function CreatorPlaceholder({ title, description }) {
  return (
    <div className="max-w-[1400px] mx-auto space-y-6">
      <div className="card relative overflow-hidden bg-gradient-to-br from-indigo-500/5 to-purple-500/5 border-indigo-100 dark:border-indigo-900/60 p-5 sm:p-6 rounded-2xl shadow-card">
