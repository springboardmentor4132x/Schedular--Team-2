...
export default function ContentScheduling() {
  ...
  return (
    <div className="space-y-6 max-w-[1400px] mx-auto animate-fade-in pb-20">
      ...
      <section className="card px-5 sm:px-6 py-4 bg-white dark:bg-slate-800 border-slate-100 dark:border-slate-700/60 shadow-card flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 items-start">
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            {activePublishingItem && (
              <div className="card p-5 space-y-4 shadow-card bg-gradient-to-r from-indigo-50/20 to-slate-50/20 dark:from-indigo-950/10 dark:to-slate-800/10 border-indigo-100 dark:border-indigo-900/30">
