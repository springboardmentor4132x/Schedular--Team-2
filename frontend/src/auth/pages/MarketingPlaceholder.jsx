...
export default function MarketingPlaceholder({ isDark, onToggleTheme }) {
  return (
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        ...
        >
          ...
          <p className="text-sm sm:text-base leading-relaxed mb-6" style={{ color: 'var(--text-muted)' }}>
            Welcome to the Marketing Team Workspace. Coordinate content strategy, campaign approval pipelines, content libraries, and team workspaces.
          </p>
