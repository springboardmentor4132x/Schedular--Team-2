...
export default function RoleSelection({ isDark, onToggleTheme }) {
  ...
  const roles = [
    {
      ...
      icon: HiShieldCheck,
      title: 'Admin',
      desc: 'For platform administrators managing users, teams, and system settings.',
      benefits: ['Full platform access', 'User management', 'System analytics'],
    },
    {
      id: 'creator',
      icon: HiUser,
  ...
  const handleContinue = () => {
    ...
    navigate(routeMap[selected] || '/admin')
  }
